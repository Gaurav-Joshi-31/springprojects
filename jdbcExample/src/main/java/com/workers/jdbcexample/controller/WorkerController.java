...
public class WorkerController {
	...
	public String create() {
		try {
			repository.add( new Worker(101, "Gaurav", "Joshi", "10000", new Date(System.currentTimeMillis()), "IT",
					"gaurav@gmail.com"));
	...
	public String update() {
		try {
			repository.update( new Worker(101, "Gaurav", "Joshi", "10000", new Date(System.currentTimeMillis()), "IT",
					"mfs.akash@gmail.com"));
